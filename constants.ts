...
export const INITIAL_MENU: MenuCategory[] = [
  {
    ...
    name: 'Entradas',
    items: [
      { name: 'Empanadas Salteñas', price: '$0', desc: 'Carne cortada a cuchillo, fritas o al horno.', image: '' },
      { name: 'Rabas a la Romana', price: '$0', desc: 'Anillos de calamar tiernos con limón y perejil.', image: '' },
      { name: 'Tortilla de Papas', price: '$0', desc: 'Clásica tortilla española, opción babé disponible.', image: '' },
      { name: 'Provoleta Maral', price: '$0', desc: 'Queso provolone fundido con orégano y aceite de oliva.', image: '' }
    ]
  },
  {
    id: 'minutas',
    ...
    items: [
      ...
      { name: 'Suprema a la Suiza', price: '$0', desc: 'Pechuga de pollo con salsa blanca y gratén de queso.', image: '' },
      { name: 'Revuelto Gramajo', price: '$0', desc: 'Papas pay, huevo, jamón cocido y arvejas.', image: '' }
    ]
  },
  {
    id: 'parrilla',
    ...
    items: [
      ...
      { name: 'Vacío del Fino', price: '$0', desc: 'Corte tierno cocción lenta a la brasa.', image: '' },
      { name: 'Asado de Tira', price: '$0', desc: 'Costillar seleccionado de exportación.', image: '' },
      { name: 'Parrillada Completa (2 pers)', price: '$0', desc: 'Chorizo, morcilla, chinchulín, riñón, asado y vacío.', image: '' }
    ]
  },
  {
    id: 'pastas',
    ...
    items: [
      ...
      { name: 'Ñoquis de Papa', price: '$0', desc: 'Hechos a mano todos los días.', image: '' },
      { name: 'Sorrentinos Maral', price: '$0', desc: 'Rellenos de jamón, mozzarella y ricota.', image: '' }
    ]
  },
  {
    id: 'postres',
    name: 'Postres',
    items: [
      { name: 'Flan Casero', price: '$0', desc: 'Con dulce de leche y/o crema.', image: '' },
      { name: 'Queso y Dulce', price: '$0', desc: 'Postre vigilante: Queso fresco con dulce de batata o membrillo.', image: '' },
      { name: 'Mousse de Chocolate', price: '$0', desc: 'Artesanal con virutas de chocolate amargo.', image: '' }
    ]
  }
];
